...
insert into user_details (id, birth_date, name) values (10004, CURRENT_DATE(), 'Mbombo');
insert into user_details (id, birth_date, name) values (10005, CURRENT_DATE(), 'Ndjip');